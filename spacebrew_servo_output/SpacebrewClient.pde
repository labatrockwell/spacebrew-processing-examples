...
public class SpacebrewClient {
  ...
  PApplet parent;
  Method  onRangeMessageMethod, onStringMessageMethod, onBooleanMessageMethod;
  ...
  private void setupMethods(){
    try {
      ...
      println("no onRangeMessage method implemented");
    }
    ...
    if ( type.equals("string") ){
      ...
      if ( onRangeMessageMethod != null ){
        try {
          ...
          println("onRangeMessageMethod invoke failed, disabling :(");
